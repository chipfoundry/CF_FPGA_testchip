...
`endif
    ...
    //Tile_X0Y1_Direction.NORTH
        ...
        input  [0:0] Tile_X0Y1_CI, //Port(Name=CI,IO=INPUT,XOffset=0,YOffset=-1,WireCount=1,Side=S)
    //Tile_X0Y1_Direction.EAST
 ...
 //Tile_X0Y1_Direction.NORTH
    ...
    wire[0:0] Tile_X0Y1_CO; //Port(Name=CO,IO=OUTPUT,XOffset=0,YOffset=-1,WireCount=1,Side=N)
