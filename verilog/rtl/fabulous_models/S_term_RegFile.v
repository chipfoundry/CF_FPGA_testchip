...
S_term_RegFile_ConfigMem
`ifdef EMULATION
    #(
    .Emulate_Bitstream(Emulate_Bitstream)
    )
`endif
    Inst_S_term_RegFile_ConfigMem
    (
    .FrameData(FrameData),
...
S_term_RegFile_switch_matrix Inst_S_term_RegFile_switch_matrix (
    ...
    .NN4BEG14(NN4BEG[14]),
    .NN4BEG15(NN4BEG[15]),
    .ConfigBits(ConfigBits[8-1:0]),
    .ConfigBits_N(ConfigBits_N[8-1:0])
);
