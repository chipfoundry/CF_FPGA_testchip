...
wire[7-1:0] W_GBUF_FEED_BEG0_input;
wire[7-1:0] W_GBUF_FEED_BEG1_input;
wire[7-1:0] W_GBUF_FEED_BEG2_input;
wire[7-1:0] W_GBUF_FEED_BEG3_input;
...
wire[8-1:0] D_EN_input;
 ...
 //switch matrix multiplexer W_GBUF_FEED_BEG0 MUX-7
assign W_GBUF_FEED_BEG0_input = {D_OUT,C_OUT,B_OUT,A_OUT,S2END7,S1END1,W_GBUF_FEED_END0};
cus_mux81 inst_cus_mux81_W_GBUF_FEED_BEG0 (
    ...
    .A5(W_GBUF_FEED_BEG0_input[5]),
    .A6(W_GBUF_FEED_BEG0_input[6]),
    .A7(GND0),
    .S0(ConfigBits[0+0]),
 ...
 //switch matrix multiplexer W_GBUF_FEED_BEG1 MUX-7
assign W_GBUF_FEED_BEG1_input = {D_OUT,C_OUT,B_OUT,A_OUT,S2END6,S1END2,W_GBUF_FEED_END1};
cus_mux81 inst_cus_mux81_W_GBUF_FEED_BEG1 (
    ...
    .A5(W_GBUF_FEED_BEG1_input[5]),
    .A6(W_GBUF_FEED_BEG1_input[6]),
    .A7(GND0),
    .S0(ConfigBits[3+0]),
 ...
 //switch matrix multiplexer W_GBUF_FEED_BEG2 MUX-7
assign W_GBUF_FEED_BEG2_input = {D_OUT,C_OUT,B_OUT,A_OUT,S2END5,S1END3,W_GBUF_FEED_END2};
cus_mux81 inst_cus_mux81_W_GBUF_FEED_BEG2 (
    ...
    .A5(W_GBUF_FEED_BEG2_input[5]),
    .A6(W_GBUF_FEED_BEG2_input[6]),
    .A7(GND0),
    .S0(ConfigBits[6+0]),
 ...
 //switch matrix multiplexer W_GBUF_FEED_BEG3 MUX-7
assign W_GBUF_FEED_BEG3_input = {D_OUT,C_OUT,B_OUT,A_OUT,S2END4,S1END0,W_GBUF_FEED_END3};
cus_mux81 inst_cus_mux81_W_GBUF_FEED_BEG3 (
    ...
    .A5(W_GBUF_FEED_BEG3_input[5]),
    .A6(W_GBUF_FEED_BEG3_input[6]),
    .A7(GND0),
    .S0(ConfigBits[9+0]),
...
assign N1BEG1_input = {B_OUT,S1END2};
...
assign N1BEG2_input = {C_OUT,S1END1};
...
assign N1BEG3_input = {D_OUT,S1END0};
...
assign N4BEG0_input = {A_OUT,S1END2};
...
assign N4BEG1_input = {B_OUT,S1END3};
...
assign N4BEG2_input = {A_OUT,SS4END15};
...
assign N4BEG3_input = {B_OUT,SS4END14};
...
assign N4BEG4_input = {A_OUT,S1END2};
...
assign N4BEG5_input = {B_OUT,S1END3};
...
assign N4BEG6_input = {A_OUT,SS4END15};
...
assign N4BEG7_input = {B_OUT,SS4END14};
...
assign N4BEG8_input = {C_OUT,S1END1};
...
assign N4BEG9_input = {D_OUT,S1END0};
...
assign N4BEG10_input = {C_OUT,SS4END13};
...
assign N4BEG11_input = {D_OUT,SS4END12};
...
assign N4BEG12_input = {C_OUT,S1END1};
...
assign N4BEG13_input = {D_OUT,S1END0};
...
assign N4BEG14_input = {C_OUT,SS4END13};
...
assign N4BEG15_input = {D_OUT,SS4END12};
...
assign NN4BEG1_input = {B_OUT,S4END10,S4END8,S4END6};
...
assign NN4BEG2_input = {C_OUT,S4END5,S4END3,S4END1};
...
assign NN4BEG3_input = {D_OUT,S4END11,S4END9,S4END7};
...
assign NN4BEG11_input = {B_OUT,S4END10,S4END8,S4END6};
...
assign NN4BEG12_input = {C_OUT,S4END5,S4END3,S4END1};
...
assign NN4BEG13_input = {D_OUT,S4END11,S4END9,S4END7};
...
assign A_IN_input = {VCC0,GND0,SS4END0,S4END0,S2END4,S2END0,S2MID0,S1END0};
...
assign A_EN_input = {VCC0,GND0,SS4END4,S4END4,S2END4,S2END0,S2MID4,S1END0};
...
assign B_IN_input = {VCC0,GND0,SS4END1,S4END1,S2END5,S2END1,S2MID1,S1END1};
...
assign B_EN_input = {VCC0,GND0,SS4END5,S4END5,S2END5,S2END1,S2MID5,S1END1};
...
assign C_CLK_input = {E_GBUF_END3,E_GBUF_END2,E_GBUF_END1,E_GBUF_END0};
...
assign C_IN_input = {VCC0,GND0,SS4END2,S4END2,S2END6,S2END2,S2MID2,S1END2};
...
assign C_EN_input = {VCC0,GND0,SS4END6,S4END6,S2END6,S2END2,S2MID6,S1END2};
...
assign D_CLK_input = {E_GBUF_END3,E_GBUF_END2,E_GBUF_END1,E_GBUF_END0};
...
assign D_IN_input = {VCC0,GND0,SS4END3,S4END3,S2END7,S2END3,S2MID3,S1END3};
...
assign D_EN_input = {VCC0,GND0,SS4END7,S4END7,S2END7,S2END3,S2MID7,S1END3};
