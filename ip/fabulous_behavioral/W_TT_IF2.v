...
`endif
    ...
    (
    //Tile_X0Y0_Direction.SOUTH
        input  [3:0] Tile_X0Y0_S_GBUF_FEED_END, //Port(Name=S_GBUF_FEED_END,IO=INPUT,XOffset=0,YOffset=1,WireCount=4,Side=N)
    ...
    //Tile_X0Y1_Direction.SOUTH
        output  [3:0] Tile_X0Y1_S_GBUF_FEED_BEG, //Port(Name=S_GBUF_FEED_BEG,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=4,Side=S)
 ...
 //signal declarations
 //Tile_X0Y0_Direction.SOUTH
    wire[3:0] Tile_X0Y0_S_GBUF_FEED_BEG; //Port(Name=S_GBUF_FEED_BEG,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=4,Side=S)
...
`endif
    ...
    .S_GBUF_FEED_END(Tile_X0Y0_S_GBUF_FEED_END),
