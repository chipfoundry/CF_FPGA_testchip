...
assign SLOT0_input = {VCC0,GND0,SS4END0,S4END4,S4END0,S2END4,S2MID0,S1END0};
cus_mux81 inst_cus_mux81_SLOT0 (
    .A0(SLOT0_input[0]),
    .A1(SLOT0_input[1]),
    .A2(SLOT0_input[2]),
    .A3(SLOT0_input[3]),
...
assign SLOT1_input = {VCC0,GND0,SS4END1,S4END5,S4END1,S2END5,S2MID1,S1END1};
cus_mux81 inst_cus_mux81_SLOT1 (
    .A0(SLOT1_input[0]),
    .A1(SLOT1_input[1]),
    .A2(SLOT1_input[2]),
    .A3(SLOT1_input[3]),
...
assign SLOT2_input = {VCC0,GND0,SS4END2,S4END6,S4END2,S2END6,S2MID2,S1END2};
cus_mux81 inst_cus_mux81_SLOT2 (
    .A0(SLOT2_input[0]),
    .A1(SLOT2_input[1]),
    .A2(SLOT2_input[2]),
    .A3(SLOT2_input[3]),
...
assign SLOT3_input = {VCC0,GND0,SS4END3,S4END7,S4END3,S2END7,S2MID3,S1END3};
cus_mux81 inst_cus_mux81_SLOT3 (
    .A0(SLOT3_input[0]),
    .A1(SLOT3_input[1]),
    .A2(SLOT3_input[2]),
    .A3(SLOT3_input[3]),
 ...
 //switch matrix multiplexer TRIGGER MUX-8
assign TRIGGER_input = {VCC0,GND0,SS4END3,S4END7,S4END3,S2END3,S2MID3,S1END3};
cus_mux81 inst_cus_mux81_TRIGGER (
    .A0(TRIGGER_input[0]),
    .A1(TRIGGER_input[1]),
    .A2(TRIGGER_input[2]),
    .A3(TRIGGER_input[3]),
